  ...
  return (
    <div className="pointer-events-none absolute inset-y-0 right-0 hidden w-[58%] overflow-visible lg:block">
      ...
      <div className="absolute left-[19%] top-[18rem] h-[280px] w-[320px]">
        ...
        <div className="absolute left-0 top-14 h-72 w-36 rotate-[16deg] rounded-[5rem_5rem_3rem_5rem] bg-[#090908] shadow-[inset_-24px_-30px_60px_rgba(255,211,0,0.16),0_28px_80px_rgba(0,0,0,0.22)]" />
        <div className="orb-yellow absolute right-6 top-0 size-28 rounded-full" />
        <div className="absolute right-5 top-16 h-72 w-36 -rotate-[16deg] rounded-[5rem_5rem_5rem_3rem] bg-brand shadow-[inset_-24px_-34px_58px_rgba(175,116,0,0.22),0_32px_80px_rgba(255,205,0,0.34)]" />
