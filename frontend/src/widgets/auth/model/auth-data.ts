...
export const demoRoles: DemoRole[] = [
  { title: "Волонтер", text: "Сотрудник Столото", helper: "Лента, отклики, часы и профиль", href: "/volunteer", registerHref: "/register/volunteer", icon: UserRound },
  { title: "Фонд", text: "НКО и партнеры", helper: "Задания, заявки и отчеты", href: "/foundation", registerHref: "/register/foundation", icon: Building2 },
