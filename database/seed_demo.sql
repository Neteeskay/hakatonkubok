...
INSERT INTO app_user (
    ...
    (
        ...
        'admin',
        'admin@stoloto.local',
        'pbkdf2_sha256$260000$R+Vnjna4DQrYvOoK09E4+w==$SQnQfAs/leAtgjn2CH6JAL/JFqmtFWVhODG8iDMjqoQ=',
    ...
    (
        ...
        NULL,
        'volunteer@stoloto.local',
        'pbkdf2_sha256$260000$X7ySAxrI6QLHhBa7CIaQEg==$C3FcPjT1P/SfJGEC4dIe+MJ8qZZfYbvxmdDqFfY8uzo=',
        'Иван Петров',
        'Нижний Новгород',
        'EMP-1001',
        'IT',
